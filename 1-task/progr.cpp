/*Какой-то код из main - пример использования генератора матриц
...
//ofstream logfile("log.txt"); //файл для отладки
...
int main()
{
	...
	//mygen(a, a_inv, n, alpha, beta, 0, 0, 2, 1); // жорданова клетка (n>2)
